package com.aboutcat.order.controller;
...
import com.aboutcat.order.service.OrderService;
...
public class OrderControllerImpl extends BaseController implements OrderController {
	...
	public ModelAndView payToOrderGoods(@RequestParam Map<String, String> receiverMap,
		...
		String orderer_phone = memberVO.getPhone();
		...
		for(int i=0; i<myOrderList.size();i++){
			...
			orderVO.setReceiver_phone(receiverMap.get("receiver_phone"));
			...
			orderVO.setPay_orderer_phone_num(receiverMap.get("pay_orderer_phone_num"));	
			orderVO.setOrderer_phone(orderer_phone);	
