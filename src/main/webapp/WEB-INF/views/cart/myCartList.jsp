...
function modify_cart_qty(goods_id,goodsprice,index){
	//alert(index);
	var total_sales_price = ${total_sales_price}+"원";
...
function fn_order_each_goods(goods_id,goods_name,goods_price,goods_image_fileName){
							...
							<!-- cartVO에 goods_id FK 기반 조회한 goodVO 객체들 -->
								...
								<td class="goods_image"><a
									href="${contextPath}/goods/goodsDetail.do?goods_id=${item.goods_id }">
										<img width="75" alt=""
										src="${contextPath}/thumbnails.do?goods_id=${item.goods_id}&goods_image_fileName=${item.goods_image_fileName}" />
								</a></td>
								<td>
									<h2>
										<a
								...
								<td><strong> <fmt:formatNumber
											...
											var="total_sales_price" /> <span id="tot_price">${total_sales_price}원</span>
								</strong></td>
								<td><a
