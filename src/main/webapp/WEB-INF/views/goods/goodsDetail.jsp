...
<hgroup>
    ...
    <h2 style="font-size: 2ex;"><a href="${contextPath}/main/main.do">모든 상품 보기</a> &gt; <a
            href="${contextPath}/goods/keyword.do?keyword=${goods.goods_keyword}"> ${goods.goods_keyword} </a></h2>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="fixed"><strong>[당일배송]</strong> 당일배송 서비스 시작!<br>
                <strong>[휴일배송]</strong> 휴일에도 배송받는 aboutCat
            </TD>
        </tr>
        <tr>
