			   ...
			   <strong>
			      <c:forEach var="item2" items="${myOrderList}" varStatus="j">
			          <c:if  test="${item.order_id ==item2.order_id}" >
			            <a href="${contextPath}/goods/goodsDetail.do?goods_id=${item2.goods_id }">${item2.goods_name }/${item.order_goods_qty }개</a><br>
			         </c:if>   
				 </c:forEach>
				</strong></td>
			<td>
...
<table border=0 width=100% cellpadding=10 cellspacing=10>
  <tr>
    ...
    <td>
	   <strong>${memberInfo.member_email1 }@${memberInfo.member_email2 }</strong>
   </td>
   </tr>
   <tr>
    <td>
   ...
   <tr>
    ...
    <td>
		도로명:  &nbsp;&nbsp; <strong>${memberInfo.address1_new }</strong>  <br>
		지번:   &nbsp;&nbsp; <strong>${memberInfo.address1_old }</strong> 
   </td>
   </tr>
</table>
</body>
