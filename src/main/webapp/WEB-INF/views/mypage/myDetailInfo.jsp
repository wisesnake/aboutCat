...
<script>
	...
	function fn_modify_member_info(attribute) {
		...
		if (attribute == 'member_pw') {
			...
			value = value_member_email1 + "," + value_member_email2 + ","
					+ value_email_valid_check;
			//alert(value);
			...
			value = value_postcode + "," + value_address1_new + ","
					+ value_address1_old + "," + value_address2;
		}
				...
				<tbody>
					...
					<tr class="dot_line">
						...
						<td><input type="text" name="phone" size=30
							value="${memberInfo.phone }"><br> <br> <c:choose>
						...
						<td><input type="button" value="수정하기"
							onClick="fn_modify_member_info('phone')" /></td>
					</tr>
					<tr class="dot_line">
						<td class="fixed_join">이메일<br>(e-mail)
						</td>
						<td><input type="text" name="member_email1" size=10
							value="${memberInfo.member_email1 }" /> @ <input type="text"
							size=10 name="member_email2" value="${memberInfo.member_email2 }" />
						...
						<br> <c:choose>
								<c:when test="${memberInfo.email_valid_check=='true' }">
									<input type="checkbox" name="email_valid_check" value="true"
					...
					<tr class="dot_line">
						...
						<td><input type="text" id="postcode" name="postcode" size=5
							value="${memberInfo.postcode }"> <a
							href="javascript:execDaumPostcode()">우편번호검색</a> <br>
							<p>
								지번 주소:<br>
								<input type="text" id="address1_new" name="address1_new"
									size="50" value="${memberInfo.address1_new }"><br>
								<br> 도로명 주소: <input type="text" id="address1_old"
									name="address1_old" size="50"
									value="${memberInfo.address1_old }"><br>
								<br> 나머지 주소: <input type="text" name="address2" size="50"
