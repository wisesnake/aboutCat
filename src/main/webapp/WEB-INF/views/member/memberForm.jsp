			...
			<table>
				<tbody>
					<tr class="dot_line">
						...
						<td><input type="text" name="_member_id" id="_member_id" size="20" /> 
							<input type="hidden" name="member_id" id="member_id" /> 
							<input type="button" id="btnOverlapped"	value="중복체크" onClick="fn_overlapped()" /></td>
					</tr>
					<tr class="dot_line">
					...
					<tr class="dot_line">
						...
						</select>월 <select name="birth_month">
